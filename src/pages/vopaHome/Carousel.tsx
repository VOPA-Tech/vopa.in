  ...
  const slides = [
    {
      ...
      description:
        "What if every child could learn through a smartphone - no internet needed?",
    ...
    },
    {
      title1: "The Solution",
      title2:
        "Effective teaching and personalized learning despite classroom challenges.",
    ...
    },
    {
      title1: "The Vision",
      title2:
        "Regular updates in their own language to bridge home and school.",

      description:
        "What if every parent was truly connected to their child's learning?",
    ...
    },
    {
      title1: "The Vision",
      title2:
        "Daily self-help and professional care in local languages, all free.",

      description:
        "What if mental health support was proactive and accessible?",
