...
const ProjectCardsSlider = () => {
  return (
    <section className="section bg-light pt-5  py-sm-4 position-relative features-4">
      <Container>
        <Row className="justify-content-center">
          <Col className="text-start">
            <h1 className="display-5 fw-medium">
              We're shaping a world where every child has the tools to learn,
              the strength to grow, and the freedom to flourish.
            </h1>
            <p className="mb-0">
        ...
        <Row className="">
          ...
          <Col xs="auto" className="text-sm-right pt-2 pt-sm-0">
            <div className="navigations">
              <Button
                variant="link"
                className="text-normal icon-md p-0 swiper-custom-prev"
              >
                <FeatherIcon icon="arrow-left" className="icon-dual" />
              </Button>
              <Button
                variant="link"
                className="text-normal icon-md p-0 swiper-custom-next"
              >
