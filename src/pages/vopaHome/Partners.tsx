      ...
      <Container>
        <Row className="">
          <Col className="text-center">
            ...
            <p className="text-muted mx-auto">
              <span className="text-dark fw-bold">VOPA</span> collaborates with
              government bodies, NGOs, and educational partners to scale impact
              across Maharashtra.
            </p>
          </Col>
        </Row>
        <Row className="mt-5 justify-content-center gap-4 flex-wrap">
          {partners.map((logo, idx) => (
            ...
            >
              <img
                src={`/images/homePage/partners/${logo}`}
                alt={`partner-${idx}`}
                height="45"
              />
            </Col>
